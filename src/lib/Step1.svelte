<script lang="ts">
	...
	import { delay, getAmountForTokenSet, getWalletWithUnit, loadMint } from "./utils";
...
<div class="flex flex-col gap-5 justify-center items-center">
	...
	{#if $mint}
		...
		<button onclick={confirm} class="btn btn-secondary w-full" disabled={isConnecting}>Confirm </button>
	{/if}
		...
		<div class="h-fit">
			...
			>
				{#each $prints as print}
					<div
						class="flex gap-2 flex-col bg-base-300 rounded-lg p-2 w-80"
					>
						<button
