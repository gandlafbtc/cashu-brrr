...
<div class="flex flex-col gap-2 items-center w-full">
	...
	<button class="btn btn-primary mt-2" on:click={()=>isBrrr=true}> Print now! BRRRRRRRRRR </button>
	...
	<div class="flex flex-col gap-1 items-center pt-10">
			...
			x
			<span class="font-bold badge badge-warning gap-2">{selectedDenomination} sats
